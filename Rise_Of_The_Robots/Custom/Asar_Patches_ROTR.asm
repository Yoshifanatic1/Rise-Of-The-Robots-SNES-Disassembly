...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the ROTR_InsertIntegratedPatches and ROTR_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro ROTR_InsertIntegratedPatches()
...
macro ROTR_ApplyPatchesPostAssembly()
...
macro ROTR_HandleDefaultPatches()
