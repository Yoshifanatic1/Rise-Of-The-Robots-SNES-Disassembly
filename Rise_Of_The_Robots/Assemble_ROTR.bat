...
set asarVer=asar
set GAMDID="ROTR"
set FolderName="Rise_Of_The_Robots"
set ROMVer=
set ROMExt=.sfc
set HackCheck=""
set HackName=""
...
echo Valid options: "ROTR_U" "ROTR_E"
...
if "%Input1%" equ "ROTR_U" goto :USA
if "%Input1%" equ "ROTR_E" goto :PAL
...
:USA
set ROMVer=(U)
set ROMNAME=Rise of the Robots
goto :Assemble
